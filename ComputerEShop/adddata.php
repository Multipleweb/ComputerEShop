            ...
            <table>
                ...
                <tr>
                    <td style="width:920px; vertical-align: top">
                        ...
                        <form name="frmAddNew" action="add_qur.php" method="post" enctype="multipart/form-data">
                        ...
                        <td style="width:700px; padding: 5px">
                            <input type="text" name="id" style="width:650px;  font-size:20pt">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px"><input type="text" name="txtprice" type="text" name="name" style="width: 600px;  font-size:15px; outline: none; border: 2px solid green; height: 30px;"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px">
                                        <select name="txtram" id="" style="width: 610px;  font-size:15px; outline: none; border: 2px solid green; height: 35px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px">
                                        <select name="txtstored" id="" style="width: 610px;  font-size:15px; outline: none; border: 2px solid green; height: 35px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 5px"><input name="txtcolor" type="text" name="name" style="width: 600px;  font-size:15px; outline: none; border: 2px solid green; height: 30px;"></td>
                                </tr>
                                <tr>
